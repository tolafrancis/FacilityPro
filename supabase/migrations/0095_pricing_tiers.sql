...
insert into fp_plans (code, name_i18n, price, price_year, currency, interval, limits, features, sort, active, contact_sales) values
  ...
  ('pro', '{"en":"Professional","vi":"Chuyên nghiệp"}', 49, 490, 'USD', 'month',
    ...
    '["Everything in Starter","Workflows & automation","SLA targets & approvals","Vendors & contracts","Surveys & broadcasts","Email & Zalo inbox","TV display boards","Full reports & dashboards"]',
    2, true, false),
  ('business', '{"en":"Business","vi":"Doanh nghiệp"}', 99, 990, 'USD', 'month',
    '{"members":75,"sites":20}',
    '["Everything in Professional","Budgets, procurement & invoices","Permit to work","Room & desk booking","IoT sensors & alerts","Technician attendance","Smart assistant & sentiment","SMS alerts"]',
    3, true, false),
  ('enterprise', '{"en":"Enterprise","vi":"Doanh nghiệp lớn"}', 0, null, 'USD', 'month',
    '{}',
    '["Everything in Business","Unlimited users, sites & assets","Modbus edge gateway","WhatsApp inbox","Custom integrations","Onboarding & data import","Dedicated support"]',
    4, true, true)
