...
const T = {
  en: {
    ...
    tiersNote: 'Pay yearly and save up to 20%: Starter $24, Professional $39 and Business $79 per month, billed annually. Occupants and vendors are free on every plan.',
  ...
  vi: {
    ...
    tiersNote: 'Thanh toán theo năm để tiết kiệm đến 20%: Khởi đầu $24, Chuyên nghiệp $39 và Doanh nghiệp $79 mỗi tháng, thanh toán hằng năm. Cư dân và nhà cung cấp được miễn phí ở mọi gói.',
